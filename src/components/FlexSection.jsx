...
const FlexSection = ({
  ...
  return (
    <section
      className={`flex items-center ${flexDirection} justify-between w-8/12 mb-16 md:mb-12 mx-auto`}
    >
      <motion.div
     ...
     viewport={{ once: false }} 
      ...
      <motion.div
        ...
        transition={{ duration: 1, delay: 0.5 }}
        viewport={{ once: false }}
        className="bg-black grid items-center w-1/2 place-items-center md:w-2/5 md:mb-10"
      >
